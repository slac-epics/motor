...
public:
  Pico8742Controller(const char *portName, const char *Pico8742PortName, int numAxes, double movingPollPeriod, double idlePollPeriod);
...
protected:
  ...
  #define LAST_Pico8742_PARAM Pico8742FirmwareString_
