    ...
    pAsynUserIMS(0)
{
	...
	createParam(ImsMDrivePlusErrorCodeString, asynParamInt32, &this->ImsMDrivePlusErrorCode_);
	createParam(ImsMDrivePlusErrorStringString, asynParamOctet, &this->ImsMDrivePlusErrorString_);
