...
asynStatus SmartAxisBase::move(double position, int relative, double minVelocity, double maxVelocity, double acceleration)
{
  return asynSuccess;
}

asynStatus SmartAxisBase::home(double minVelocity, double maxVelocity, double acceleration, int forwards)
{
  return asynSuccess;
}

asynStatus SmartAxisBase::moveVelocity(double minVelocity, double maxVelocity, double acceleration)
{
  return asynSuccess;
}
...
asynStatus SmartAxisBase::setClosedLoop(bool closedLoop)
{
  return asynSuccess;
}


asynStatus SmartAxisBase::setPGain(double pGain)
{
  return asynSuccess;
}

asynStatus SmartAxisBase::setIGain(double iGain)
{
  return asynSuccess;
}

asynStatus SmartAxisBase::setDGain(double dGain)
{
  return asynSuccess;
}

asynStatus SmartAxisBase::setHighLimit(double highLimit)
{
  return asynSuccess;
}

asynStatus SmartAxisBase::setLowLimit(double lowLimit)
{
  return asynSuccess;
}
...
asynStatus SmartAxisBase::poll(bool *moving)
{ 
  return asynSuccess;
}
